 ...
 * tax_rules.js
 *
 * TaxOpt 계산 엔진 v0.3-B — 세법 규칙 데이터 모듈
 *
 * 책임:
 ...
 *   - v0.3-B 추가: LAW_REFS.finalReturnAggregation 1키 (법 제104조 ⑤ + 제55조 ①)
 *
 * 참조 문서:
 *   - 모듈 스펙:    docs/v0.3/modules/tax_rules.md v0.3-B (단일 진본)
 *   - 작업지시서:   docs/05_code_work_orders/v0_3_B/07_v0_3_B.md
 *   - 명세서:       docs/v0.3/02_calc_engine_spec.md v0.3-B
...
(function (global) {
  ...
  var RULE_VERSION = 'v0.3.1-final-return-v3';
  ...
  /** 적용 법령 라벨 (UI·로그용). v0.1 6키 + v0.2 신규 4키 + v0.3-A 신규 1키 + v0.3-B 신규 1키 = 12종. */
  var LAW_REFS = {
    ...
    // v0.3-B 신규 — 의사결정 #13 (확정신고 v3 산식, 법 제104조 ⑤ 정확본). 시행령 인용 0건.
